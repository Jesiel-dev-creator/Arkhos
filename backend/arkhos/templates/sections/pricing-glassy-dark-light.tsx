...
export default function PricingGlassyCards() {
  ...
  const ToggleSwitch = ({ enabled, onChange, isDark = false }: { enabled: boolean; onChange: (v: boolean) => void; isDark?: boolean }) => (
    <div className="flex items-center gap-3">
      <button
        ...
        className={[
          ...
          enabled
            ? isDark ? "bg-neutral-100 ring-neutral-300" : "bg-neutral-900 ring-neutral-900"
            : isDark ? "bg-neutral-800 ring-neutral-700" : "bg-neutral-200 ring-neutral-300",
        ].join(" ")}
  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-[900px] mx-auto">
        <div className="rounded-3xl p-2 bg-white/65 backdrop-blur-md border border-neutral-200/70 shadow-[0_12px_40px_-15px_rgba(0,0,0,0.15)] ring-1 ring-inset ring-white/40">
          <div className="rounded-2xl p-8 mb-2 bg-white/80 backdrop-blur-sm border border-neutral-200/80 ring-1 ring-inset ring-neutral-900/5">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-neutral-900">Starter</h2>
                <p className="text-neutral-600 text-base leading-relaxed mt-1">Launch quickly with a solid landing page.</p>
              </div>
              <span className="inline-flex items-center rounded-full border border-neutral-200 bg-white/70 px-3 py-1 text-xs font-medium text-neutral-700 backdrop-blur">Most Friendly</span>
            </div>
            ...
            <button className="w-full rounded-xl font-semibold text-base py-4 bg-neutral-900 text-white hover:opacity-95 transition-opacity duration-200 flex items-center justify-center gap-2.5 shadow-[0_4px_18px_-6px_rgba(0,0,0,0.4)] ring-1 ring-inset ring-neutral-900/10">
              Book a call
        ...
        <div className="rounded-3xl p-2 bg-neutral-900/60 backdrop-blur-md border border-neutral-800 shadow-[0_12px_50px_-15px_rgba(0,0,0,0.55)] ring-1 ring-inset ring-white/5 dark">
          <div className="rounded-2xl p-8 mb-2 bg-neutral-900/70 backdrop-blur-sm border border-neutral-800 ring-1 ring-inset ring-white/10">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-neutral-400 text-base leading-relaxed mt-1">Go further with more concepts and polish.</p>
              </div>
              <span className="inline-flex items-center rounded-full border border-neutral-700 bg-neutral-900/50 px-3 py-1 text-xs font-medium text-neutral-300 backdrop-blur">Best Value</span>
            </div>
            <div className="flex items-baseline mb-8">
            ...
            <button className="w-full rounded-xl font-semibold text-base py-4 bg-white text-neutral-900 hover:opacity-95 transition-opacity duration-200 flex items-center justify-center gap-2.5 shadow-[0_4px_18px_-6px_rgba(255,255,255,0.35)] ring-1 ring-inset ring-white/30">
              Book a call
              <Calendar className="w-5 h-5 text-neutral-600" />
            </button>
          </div>
          <div className="px-6 pb-6 pt-4 bg-neutral-900/55 backdrop-blur-sm rounded-2xl border border-neutral-800 ring-1 ring-inset ring-white/10">
            <div className="grid grid-cols-2 gap-y-4 gap-x-4">
