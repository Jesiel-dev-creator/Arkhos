...
export default function FooterNewsletterSocial() {
  return (
    <footer className="bg-background text-foreground relative w-full pt-20 pb-10">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 rounded-2xl border border-foreground/10 bg-background/50 backdrop-blur-sm p-8 md:p-12">
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="text-foreground/70 mb-6">
                Join thousands of professionals who trust us for
              ...
              {socialIcons.map((item, i) => {
                ...
                return (
                  <a
                    ...
                    className="border border-foreground/10 hover:bg-primary/10 flex h-10 w-10 items-center justify-center rounded-full transition"
                  >
