                        ...
                        <div className="grid items-center gap-12 divide-y p-12 md:grid-cols-2 md:divide-x md:divide-y-0">
                            ...
                            <div className="relative">
                                ...
                                <div className="mt-12 flex flex-wrap items-center justify-between gap-6">
                                    <img crossOrigin="anonymous" className="h-5 w-fit" src="https://html.tailus.io/blocks/customers/nvidia.svg" alt="Nvidia Logo" height="20" width="auto" />
                                    <img crossOrigin="anonymous" className="h-4 w-fit" src="https://html.tailus.io/blocks/customers/column.svg" alt="Column Logo" height="16" width="auto" />
                                    <img crossOrigin="anonymous" className="h-4 w-fit" src="https://html.tailus.io/blocks/customers/github.svg" alt="GitHub Logo" height="16" width="auto" />
                                    <img crossOrigin="anonymous" className="h-5 w-fit" src="https://html.tailus.io/blocks/customers/nike.svg" alt="Nike Logo" height="20" width="auto" />
                                </div>
                            </div>
                        </div>
                    </Card>
