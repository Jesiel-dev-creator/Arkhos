    ...
    <div className="min-h-screen bg-[#0c0414] text-white flex flex-col relative overflow-x-hidden">
      ...
      <header className="flex justify-between items-center p-6">
        <div className="flex items-center gap-2">
          <img src="https://picsum.photos/30/30" crossOrigin="anonymous" width={30} height={30} alt="logo" />
          <div className="font-bold text-md">Brand</div>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {/* Subtitle */}
          <p className="text-md">
            Create amazing websites with just a few lines of prompt.
          </p>
