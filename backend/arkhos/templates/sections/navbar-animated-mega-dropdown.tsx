...
const sampleDropdownData: DropdownData = [
    { heading: 'Account Settings', links: [{ text: 'Profile', href: '#' }, { text: 'Security', href: '#' }, { text: 'Notifications', href: '#' }] },
    { heading: 'Features', links: [{ text: 'Dashboard', href: '#' }, { text: 'Project Management', href: '#' }, { text: 'Task Tracking', href: '#' }] },
...
const menuItems: MenuItem[] = [
    { label: 'Personal', href: '#', dropdownData: sampleDropdownData },
...
export default function NavbarAnimatedMegaDropdown() {
                            ...
                            {menuItems[activeMenuItemIndex]?.dropdownData && (
                                ...
                                >
                                    <a href="#" className="inline-block mb-4 text-lg font-bold text-white hover:text-gray-400 no-underline">
                                        Explore {menuItems[activeMenuItemIndex]?.label ?? 'Item'} &rarr;
                                    </a>
