...
export const StickyScroll = ({
  ...
  const linearGradients = [
    ...
    "linear-gradient(to bottom right, hsl(var(--primary) / 0.8), hsl(var(--accent)))",
  ];
  ...
  return (
    <motion.div
      className="relative flex h-[30rem] justify-center space-x-10 overflow-y-auto rounded-md bg-background p-10"
      ref={ref}
    >
