      ...
      <div className="w-full max-w-sm">
        ...
        <Auth
          ...
          appearance={{
            ...
            className: {
              social_button: "!flex-row-reverse",
            },
          }}
          ...
          localization={{
            variables: {
              sign_in: {
                ...
                social_provider_text: t("socialProvider"),
                link_text: t("hasAccount"),
              },
              sign_up: {
                email_label: t("email"),
                password_label: t("createPassword"),
                email_input_placeholder: t("emailPlaceholder"),
                password_input_placeholder: t("passwordPlaceholder"),
              ...
              magic_link: {
                ...
                loading_button_label: t("sendingMagicLink"),
                link_text: t("magicLinkOption"),
                confirmation_text: t("checkEmailMagic"),
              },
              forgotten_password: {
                email_label: t("email"),
                email_input_placeholder: t("emailPlaceholder"),
                button_label: t("resetPassword"),
                loading_button_label: t("sendingReset"),
                link_text: t("forgotPassword"),
                confirmation_text: t("checkEmailReset"),
              },
              update_password: {
                password_label: t("newPassword"),
                password_input_placeholder: t("newPasswordPlaceholder"),
                button_label: t("updatePassword"),
                loading_button_label: t("updatingPassword"),
                confirmation_text: t("passwordUpdated"),
              },
            },
          }}
        />
