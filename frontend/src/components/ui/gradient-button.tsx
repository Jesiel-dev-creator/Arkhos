...
const GradientButton = ({
  ...
  const commonGradientStyles = `
    ...
    after:content-[""] after:block after:absolute after:bg-[var(--void)]
  ...
  return (
    <div className="text-center">
      <div
        ...
        {...props}
      >
        <span className="relative z-10 text-[var(--text-primary)] flex items-center justify-center gap-2 font-medium text-sm">
          {children}
        </span>
      </div>
    </div>
